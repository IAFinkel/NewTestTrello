...
public class BoardHelper extends HelperBase {
    ...
    public void initBoardCreationfromHeader() throws InterruptedException {
     ...
     //   click(By.cssSelector("[aria-label='BoardIcon']"));
        click(By.cssSelector("._3Qtx4lodxp9J0E"));
    ...
    public void newCreation() {
        ...
        action.moveByOffset(x,y).click().perform();//клик по координате



    }

    public boolean isCreateButtonLocated() {
        WebDriverWait wait = new WebDriverWait(wd, 10);
        wait.until(ExpectedConditions.elementToBeClickable(wd.findElement(By.cssSelector("[data-test-id='header-create-menu-button']"))));
        return wd.findElement(By.cssSelector("[data-test-id='header-create-menu-button']")).isDisplayed();}
